    ...
    <div className={`side-row ${active ? 'active' : ''}`} onClick={onClick}>
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <div className="meta mono" style={{
          fontSize: 10.5, marginTop: 4, opacity: .8,
          whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis',
        }}>{metaLine}</div>
      </div>
      {needsAction && (
    ...
    <aside style={{
      ...
      <div style={{ padding: '20px 20px 14px' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 4 }}>
          <span className="eyebrow">Lanzador</span>
          <div style={{ display: 'flex', alignItems: 'center', gap: 4 }}>
            <span className="mono meta">{CONVOCATORIAS.length}</span>
            <button
              onClick={onToggleCollapsed}
        ...
        <h1 className="serif" style={{ margin: '4px 0 18px', fontSize: 26, fontWeight: 400, letterSpacing: '-0.02em' }}>
          Convocatorias
        </h1>
