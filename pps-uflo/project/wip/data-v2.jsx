...
// Closure of the day — what got done, what stays open
const CIERRE = {
  done: [
    { what: "Contactaste 3 instituciones", detail: "Borda, Manantiales, Ameghino" },
    { what: "Revisaste 5 solicitudes", detail: "4 aprobadas · 1 con corrección" },
    { what: "Confirmaste selección PPS Investigación", detail: "5 estudiantes" },
    { what: "Marcaste 3 recordatorios como hechos", detail: "" },
  ],
  pendingFlat: [
    { what: "Hospital Italiano · preparar cierre académico", when: "Vence vie 31 may" },
    { what: "Cohorte 2026 · revisar con Decanato", when: "Reunión jue 28" },
  ],
  hermesTomorrow: "Te despierto mañana con el estado de las 3 conversaciones de hoy y un primer corte de candidatos para la cohorte 2026.",
};

Object.assign(window, { BRIEFING, PRIORITIES, AGENDA, PULSE, ACTIVITY, DRAFTS, TODAY, TIME, USER, CIERRE });
