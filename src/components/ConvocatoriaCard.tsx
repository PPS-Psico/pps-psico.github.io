...
const ConvocatoriaCard: React.FC<ConvocatoriaCardProps> = ({
  ...
  const baseButtonClasses =
    "w-full sm:w-auto h-12 px-6 rounded-xl font-bold text-sm flex items-center justify-center gap-2.5 transition duration-200 shadow-sm border select-none min-w-[240px]";
