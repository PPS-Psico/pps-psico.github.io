    ...
    >
      ...
      <div className="p-4">
        <p className="text-sm text-slate-600 dark:text-slate-300 mb-4">
          Utiliza esta herramienta al finalizar el año académico. Archivará automáticamente las
          solicitudes pendientes y reseteará el estado de gestión de las instituciones para comenzar
          el nuevo ciclo limpio.
        </p>
        <Button
          variant="danger"
