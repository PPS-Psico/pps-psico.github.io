...
const SmartBriefing: React.FC<SmartBriefingProps> = ({
  status,
  summary,
  insights,
  signals,
      ...
      <div className="relative z-10 p-6 sm:px-8 sm:pb-8 sm:pt-6 flex flex-col lg:flex-row gap-8 lg:items-start mt-2">
        ...
        <div className="flex-none lg:w-48 space-y-4">
          <div className="flex items-center gap-3">
            <div
              className={`w-12 h-12 rounded-xl flex items-center justify-center ${config.bg} border border-white/10 shadow-inner relative overflow-hidden`}
            >
              <span
