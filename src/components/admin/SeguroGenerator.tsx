    ...
    const handleFetchConvocatorias = useCallback(async () => {
        ...
        try {
            ...
            records.forEach(record => {
                ...
                const name = record[FIELD_NOMBRE_PPS_CONVOCATORIAS] || linkedLanzamiento?.[FIELD_NOMBRE_PPS_LANZAMIENTOS] || 'Sin Nombre';
                const date = record[FIELD_FECHA_INICIO_CONVOCATORIAS] || linkedLanzamiento?.[FIELD_FECHA_INICIO_LANZAMIENTOS] || 'N/A';
