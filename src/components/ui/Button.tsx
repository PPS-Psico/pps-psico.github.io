...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  danger:
    "bg-rose-600 text-white hover:bg-rose-700 hover:-translate-y-1 focus-visible:ring-rose-500 dark:focus-visible:ring-offset-slate-900 disabled:bg-rose-300",
};
