        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-violet-100 font-medium mt-1 text-sm max-w-xl">
              Activa o desactiva herramientas según tu flujo de trabajo. Estos cambios solo afectan
              a tu navegador y no modifican la experiencia de otros administradores.
            </p>
          </div>
        </div>
      </div>
