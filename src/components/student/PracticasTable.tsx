...
const GradeDisplay: React.FC<{
  ...
  const getGradeStyle = (n: string) => {
    ...
    if (!isNaN(num)) {
      if (num >= 7)
        return "text-emerald-600 dark:text-emerald-400 border-emerald-200 bg-emerald-50 dark:bg-emerald-900/20";
      if (num >= 4)
        return "text-amber-600 dark:text-amber-400 border-amber-200 bg-amber-50 dark:bg-amber-900/20";
