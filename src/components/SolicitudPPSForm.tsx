  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Form Content */}
        <form onSubmit={handleSubmit} className="flex-grow overflow-y-auto p-6 space-y-6 custom-scrollbar bg-white dark:bg-slate-900">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2">
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Nombre de la Institución <span className="text-red-500">*</span></label>
                <Input name="nombreInstitucion" value={formData.nombreInstitucion} onChange={handleChange} placeholder="Ej: Hospital Zonal..." />
                {errors.nombreInstitucion && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.nombreInstitucion}</p>}
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Localidad <span className="text-red-500">*</span></label>
                <Input name="localidad" value={formData.localidad} onChange={handleChange} placeholder="Ej: Cipolletti" />
                {errors.localidad && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.localidad}</p>}
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Dirección Completa <span className="text-red-500">*</span></label>
                <Input name="direccion" value={formData.direccion} onChange={handleChange} placeholder="Calle y Altura" />
                {errors.direccion && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.direccion}</p>}
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Email de Contacto <span className="text-red-500">*</span></label>
                ...
                {errors.emailInstitucion && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.emailInstitucion}</p>}
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Teléfono <span className="text-red-500">*</span></label>
                ...
                {errors.telefonoInstitucion && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.telefonoInstitucion}</p>}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Referente Institucional (Director/Coord) <span className="text-red-500">*</span></label>
                <Input name="referente" value={formData.referente} onChange={handleChange} placeholder="Autoridad de la institución" />
                {errors.referente && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.referente}</p>}
              </div>
              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">¿Tiene convenio con UFLO?</label>
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Nombre del Lic. en Psicología (Tutor) <span className="text-red-500">*</span></label>
                ...
                <p className="text-xs text-slate-400 mt-1 font-medium">Debe ser un psicólogo/a graduado que trabaje en la institución.</p>
                {errors.nombreTutor && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.nombreTutor}</p>}
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Alcance de la Práctica</label>
                ...
                {formData.alcance === 'Grupal' && (
                  <div>
                    <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Cantidad aprox. de estudiantes <span className="text-red-500">*</span></label>
                    <Input name="cantidadEstudiantes" value={formData.cantidadEstudiantes} onChange={handleChange} placeholder="Ej: 3 o 4" />
                    {errors.cantidadEstudiantes && <p className="text-red-500 text-xs mt-1 font-semibold">{errors.cantidadEstudiantes}</p>}
                  </div>
                )}
              </div>

              <div>
                <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Descripción de Actividades <span className="text-red-500">*</span></label>
                <textarea
                  name="descripcion"
