...
export const convocatoriaSchema = z
  .object({
    ...
    final_reminder_claim_token: str,
    final_reminder_claimed_at: str,
    final_reminder_claimed_by: str,
    final_reminder_sent_at: str,
    final_reminder_sent_by: str,
