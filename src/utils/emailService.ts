...
A partir de esa información, verificamos que no alcanzaste el mínimo del **80% de asistencia requerido para la aprobación de la práctica**. Por este motivo, en aplicación de las condiciones de acreditación vigentes para las Prácticas Profesionales Supervisadas, corresponde registrar tu condición en esta PPS como **desaprobada**.
