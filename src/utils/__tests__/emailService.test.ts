...
describe("correos de desaprobación PPS", () => {
  ...
  it("envía el aviso fijo por inasistencia con copia visible a Agostina", async () => {
    ...
    expect(payload.html).toContain(
      "en aplicación de las condiciones de acreditación vigentes para las Prácticas Profesionales Supervisadas"
    );
    expect(payload.html).not.toContain("la Facultad resolvió");
