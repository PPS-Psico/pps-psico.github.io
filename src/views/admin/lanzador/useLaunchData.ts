...
export interface RosterRow {
  ...
  /** NULL = todavía no se le avisó que quedó seleccionado (cola de pendientes). */
    ...
    queryFn: async () => {
      ...
      const data = await runQuery(
        supabase
          .from("convocatorias")
          .select(
            "id, estado_inscripcion, estudiante_id, horario_asignado, horario_seleccionado, opcion_horario_asignado_id, convocatoria_preferencias(opcion_horario_id), selected_at, baja_automatica_at, consentimiento_exceptuado_at, seleccion_notificada_at, reminder_sent_at, final_reminder_sent_at, created_at"
          )
