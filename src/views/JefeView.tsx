...
const JefeView: React.FC = () => {
  ...
  const openStudentPanel = useCallback(
                ...
                <MetricsDashboard
                  onStudentSelect={(student) =>
                    openStudentPanel({
                      ...
                      createdTime: "",
                      [FIELD_LEGAJO_ESTUDIANTES]: student.legajo,
                      [FIELD_NOMBRE_ESTUDIANTES]: student.nombre,
                    } as unknown as AirtableRecord<EstudianteFields>)
                  }
                />
              )}
