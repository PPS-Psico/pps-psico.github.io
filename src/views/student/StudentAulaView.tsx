...
const StudentAulaView: React.FC = () => {
  ...
  return (
    <div className="ah-root ah-aula">
      <main className="ah-main ah-aula__main">
        <section className="ah-aula__hero">
          <div>
            <h1 className="ah-aula__title">Tu aula PPS, integrada a Mi Panel.</h1>
            <p className="ah-aula__lead">
              Guia, preguntas, descargas y entregas quedan en el mismo lugar donde seguis tus
              convocatorias, practicas y consentimiento. Moodle queda solo para cargar archivos.
            </p>
          </div>
          <div className="ah-aula__note" aria-label="Idea de integracion">
            <span>Campus PPS</span>
            <strong>Una sola experiencia</strong>
            <small>Mi Panel organiza. Moodle recibe entregas.</small>
          </div>
        </section>
