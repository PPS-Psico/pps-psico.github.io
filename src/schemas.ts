...
export const practicaFieldsSchema = z.object({
  ...
  [C.FIELD_NOMBRE_INSTITUCION_LOOKUP_PRACTICAS]: z
    .string()
    .or(z.array(z.string()))
    .optional()
    .nullable(),
  ...
  [C.FIELD_LANZAMIENTO_VINCULADO_PRACTICAS]: z
    .string()
    .or(z.array(z.string()))
    .optional()
    .nullable(),
...
export const convocatoriaFieldsSchema = z.object({
  [C.FIELD_LANZAMIENTO_VINCULADO_CONVOCATORIAS]: z
    .string()
    .or(z.array(z.string()))
    .optional()
    .nullable(),
  [C.FIELD_NOMBRE_PPS_CONVOCATORIAS]: z.string().or(z.array(z.string())).optional().nullable(),
  [C.FIELD_ESTUDIANTE_INSCRIPTO_CONVOCATORIAS]: z
    .string()
    .or(z.array(z.string()))
    .optional()
    .nullable(),
...
export const penalizacionFieldsSchema = z.object({
  ...
  [C.FIELD_PENALIZACION_CONVOCATORIA_LINK]: z
    .string()
    .or(z.array(z.string()))
    .optional()
    .nullable(),
...
export const lanzamientoPPSArraySchema = z.array(
  baseRecordSchema.merge(lanzamientoPPSFieldsSchema)
);
...
export const finalizacionPPSArraySchema = z.array(
  baseRecordSchema.merge(finalizacionPPSFieldsSchema)
);
